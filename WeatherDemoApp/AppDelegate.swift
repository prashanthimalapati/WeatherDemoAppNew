...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyCA5O-kpnQOcpPHraETti1a0rl9Rdug8Sk")
        
        // Customize the UI of GMSAutocompleteViewController
        
        // Set some colors (colorLiteral is convenient)
        let barColor: UIColor =  _ColorLiteralType(red: 56/250, green: 89/250, blue: 139/250, alpha: 1)
        let backgroundColor: UIColor =  _ColorLiteralType(red: 56/250, green: 89/250, blue: 139/250, alpha: 1)
        let textColor: UIColor =  _ColorLiteralType(red: 250/250, green: 250/250, blue: 250/250, alpha: 1)
